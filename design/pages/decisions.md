...
## 2026-07-10 — Prototype combat direction

**Status:** Partially superseded by the 2026-07-17 direction. Visual
turn-based combat remains current; spirits are deferred from the MVP.
...
## Earlier foundation decisions

The following decisions predate the presentation-first direction. They remain
here for the reasoning trail. The 2026-07-17 decision wins where they conflict.
